...
@declare_process_block_class("IonExchangeReactiveZO")
class IonExchangeReactiveZOData(ZeroOrderBaseData):
    """
    Zero-Order model for an Ion exchange unit operation with exchange reactions.
    """
    ...
    def build(self):
        ...
        self._tech_type = "ion_exchange_reactive"
